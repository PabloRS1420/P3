...
/* La siguiente función permite comparar dos elementos, devolviendo un número positivo, negativo
o cero según si el primer argumento es mayor, menor o igual que el segundo argumento */
typedef int (*cmp_elementlist_function_type)(const void*, const void*);

/* Inicializa la lista reservando memoriae inicializa todos sus elementos. */
...
/* Extrae del principio de la listarealizando una copia del elemento almacenado en dicho nodo. */
void * list_extractFirst(List* list);

/* Extrae del final de la listarealizando una copia del elemento almacenado en dicho nodo. */
